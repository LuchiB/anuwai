        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <main class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            <form class="row" method="POST" action="{{route('vendor.updateprofile')}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="col-md-9">
                                    <div class="form-row">
                                 ...
                                 <div class="btn-group">
                                    ...
                                    &nbsp;
                                    <a href="{{route('vendor.password')}}" class="btn btn-warning">Change password</a>
                                 </div>
