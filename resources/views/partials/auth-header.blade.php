...
{{-- 
                        ...
                        <div class="widget-header">
                            ...
                            <a href="{{route('cart.index')}}" class="widget-view">
                                ...
                                <div class="icon-area">  
                                    <i class="fas fa-heart" style="font-size:1rem"></i><sup style="color:#ff6a00">0</sup>
                               </div>

                                <div class="icon-area">
                                    <i class="fas fa-shopping-basket" style="font-size:1rem"></i><sup style="color:#ff6a00">{{Cart::count()}}</sup>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main_nav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('shop.index')}}">Gallery</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('artist',$artist->id) }}">{{$artist->name}}</a>               
